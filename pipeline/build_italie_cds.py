...
Etapes :
  ...
  python pipeline/build_italie_cds.py               # agrege -> docs/normales_italie.json
...
Sortie : docs/normales_italie.json (meme schema que la version Open-Meteo).
"""
...
def aggregate():
    ...
    for iy, la in enumerate(lats):
        for ix, lo in enumerate(lons):
            ...
            # fenetre recente : uniquement des annees COMPLETES (12 mois), pour rester
            # homogene entre les mois si le NetCDF s'arrete en cours d'annee
